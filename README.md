...
the box and you only need to upload it to get the selected set of characters into your Storybook. 

This will provide your local Storybook (and those of your live session players) with more information to show about
...
similar to what is provided in the [`roles.json`](https://github.com/bra1n/townsquare/blob/main/src/roles.json) for the 3 base editions.
...
The site will be available at: `https://sebbengon.github.io/CotC/`
